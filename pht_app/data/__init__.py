...
from pht_app.data.lightcurves import search_available_sectors, download_and_stitch, download_and_stitch_cached
...
__all__ = [
    ...
    "search_available_sectors", "download_and_stitch", "download_and_stitch_cached",
